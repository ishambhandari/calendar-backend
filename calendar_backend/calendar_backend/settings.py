...
SECRET_KEY = 'django-insecure-92t1p#-*x@qb$l)7^k4z@$@0qf##2e)ywe1)#nhfg5l&+8^0r9'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",  # If accessing from localhost
]
...
RABBITMQ_URL_LOCAL = "amqp://localhost"

#Celery settings
CELERY_BROKER_URL = RABBITMQ_URL_LOCAL
